...
const EventCard = ({
  ...
  const linkTarget = isCreated ? `/event/${event.id}/edit` : `/event/${event.id}`;
  const accessibleLabel = isCreated
    ? `Edit ${event.title} — ${event.date} at ${event.time}`
  ...
  return (
    <article className="relative group">
      <Link
        ...
        className="block focus:outline-none focus-visible:ring-2 focus-visible:ring-[#1A1A1A] focus-visible:ring-offset-2 focus-visible:ring-offset-white"
      >
        <div className="relative overflow-hidden mb-3">
          <div
            ...
            role="img"
            aria-label={`${event.title} background image`}
          />
          <div className="absolute top-4 left-4 flex flex-col gap-0 pointer-events-none">
      ...
      {isCreated && (
        <button
          ...
          className="absolute top-4 right-4 bg-white border border-black p-2 hover:bg-red-500 hover:text-white hover:border-red-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#1A1A1A] focus-visible:ring-offset-2 focus-visible:ring-offset-white transition-colors opacity-100 sm:opacity-0 sm:group-hover:opacity-100 sm:group-focus-within:opacity-100"
