...
const EventCard = ({
  ...
  const accessibleLabel = `${event.title} — ${event.date} at ${event.time}${eventLive ? ', live now' : ''}`;
...
const Discover = () => {
  ...
  return <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section id="main-content" className="pt-32 md:pt-40 lg:pt-48 pb-6 md:pb-16 lg:pb-24 px-4 md:px-8">
