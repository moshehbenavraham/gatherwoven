...
export const EventDetailPage: React.FC = () => {
      ...
      <div className="flex flex-col h-screen items-center justify-center bg-white px-4">
        ...
        <div className="text-center mt-20">
          ...
          <button
            type="button"
            onClick={() => navigate('/')}
            className="px-6 py-3 bg-[#1A1A1A] text-white border border-[#1A1A1A] hover:bg-white hover:text-[#1A1A1A] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#1A1A1A] focus-visible:ring-offset-2 focus-visible:ring-offset-white transition-colors uppercase text-sm font-medium"
          >
            Browse Events
          </button>
        </div>
  ...
  return <>
      ...
      <main id="main-content" className="flex h-screen justify-center items-start w-full relative bg-white mx-auto my-0 max-lg:flex-col max-lg:h-auto">
        ...
        <aside className="flex w-[540px] flex-col justify-start items-start fixed h-screen box-border right-0 top-0 bg-white overflow-y-auto max-lg:relative max-lg:w-full max-lg:h-auto max-lg:right-auto max-lg:top-0 max-lg:overflow-y-visible">
          <div className="flex w-full flex-col items-start gap-10 relative p-10 pb-24 max-lg:w-full max-lg:px-4 max-lg:py-6 max-lg:pb-6 max-lg:gap-8 opacity-0 animate-fade-in [animation-delay:200ms]">
            ...
            <EventLocation address={event.address} />
          </div>
