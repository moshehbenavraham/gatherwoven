...
export const EventsCarousel = () => {
  ...
  return (
    <section
      ...
      className="w-full overflow-hidden py-12 pb-20 md:pb-24 bg-background"
    >
      <div className="relative overflow-hidden">
        <ul className="flex gap-px w-max animate-scroll-left-fast will-change-[transform] list-none m-0 p-0">
          {multipliedEvents.map((event, index) => (
            ...
            >
              <Link
                ...
                tabIndex={index >= events.length ? -1 : undefined}
                className="relative block aspect-[4/5] max-h-[800px] overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
              >
                <img
